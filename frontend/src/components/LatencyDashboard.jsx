    ...
    <section id="performance-metrics" ref={metricsRef} className="relative w-full min-h-fit lg:h-screen lg:max-h-screen flex flex-col items-center justify-center overflow-hidden py-8 md:py-16 bg-[#06111F]">
      <div className="relative z-10 flex flex-col items-center w-full max-w-5xl mx-auto px-6 space-y-6">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <h2 className="font-['Sora'] font-bold text-[26px] md:text-[36px] leading-[1.1] text-[#d9e3f7]">
            Measured <span className="text-gradient">Intelligence</span>
          </h2>
          <p className="font-['Hanken_Grotesk'] text-[#bbc9cd]/70 max-w-[600px] text-xs">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-3">
                    <div className="flex flex-col items-end">
                      <span className="text-[9px] text-[#bbc9cd]/60 font-['JetBrains_Mono']">P50</span>
                      <span className="text-[#25d9f5] font-bold font-['JetBrains_Mono'] text-xs">145ms</span>
                    </div>
                    <div className="flex flex-col items-end">
                      <span className="text-[9px] text-[#bbc9cd]/60 font-['JetBrains_Mono']">P70</span>
                      <span className="text-[#d9e3f7] font-['JetBrains_Mono'] text-xs">178ms</span>
                    </div>
                    <div className="flex flex-col items-end">
                      <span className="text-[9px] text-[#bbc9cd]/60 font-['JetBrains_Mono']">P100</span>
                      <span className="text-[#d9e3f7] font-['JetBrains_Mono'] text-xs">196ms</span>
                    </div>
                  </div>
                </div>

                {/* Histogram Chart */}
                <div className="h-16 flex items-end gap-1.5 w-full px-2 py-2">
                  ...
                  <div className="flex-grow bg-purple-500 h-[90%] rounded-t shadow-[0_0_10px_rgba(168,85,247,0.4)]"></div>
                ...
                <div className="space-y-1.5 pt-1">
                  <div className="flex justify-between items-center py-1 border-b border-[#25d9f5]/10">
                    ...
                    <span className="font-['JetBrains_Mono'] text-[10px] text-[#d9e3f7]">42 ms</span>
                  </div>
                  <div className="flex justify-between items-center py-1 border-b border-[#25d9f5]/10">
                    <span className="font-['JetBrains_Mono'] text-[10px] text-[#bbc9cd]">RETRIEVAL</span>
                    <span className="font-['JetBrains_Mono'] text-[10px] text-[#d9e3f7]">38 ms</span>
                  </div>
                  <div className="flex justify-between items-center py-1 border-b border-[#25d9f5]/10">
                    <span className="font-['JetBrains_Mono'] text-[10px] text-[#bbc9cd]">GENERATION</span>
                    <span className="font-['JetBrains_Mono'] text-[10px] text-[#d9e3f7]">65 ms</span>
                  </div>
                  <div className="flex justify-between items-center py-1">
                    <span className="font-['JetBrains_Mono'] text-[10px] text-[#25d9f5] font-bold">TOTAL LATENCY</span>
                    <span className="font-['JetBrains_Mono'] text-[12px] text-[#25d9f5] font-bold glow-text">145 ms</span>
                  </div>
                </div>
              </div>
